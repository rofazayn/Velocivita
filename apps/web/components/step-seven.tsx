  ...
  return (
    <div className='w-full flex flex-col'>
      <div className='w-full scroll-auto'>
        <p className='text-xs text-muted-foreground tracking-wide'>Step - 07</p>
        ...
        <p className='leading-7 mt-2 font-normal text-md text-muted-foreground'>
          Select a design that suits your style and choose your preferred
          format. Get ready to share your impressive resume!
        </p>
        <Form {...form}>
