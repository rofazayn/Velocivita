          ...
          <form onSubmit={form.handleSubmit(handleStep)}>
            <div className='grid w-full items-center gap-4 mt-4'>
              ...
              {resume.work && resume.work.length > 0 && (
                <>
                  <div className='mb-8 mt-4 w-full border-t-[1px] border-input/60 py-4'>
                    <FormLabel>Previously added experience</FormLabel>
                    {resume.work.map((exp: any) => (
                      <div
                        className='w-full my-3 rounded-md px-4 py-3 flex flex-row gap-4 justify-between items-center border-[1px] border-input/60'
                        key={exp.id}
                      >
                        <p className='text-sm'>
